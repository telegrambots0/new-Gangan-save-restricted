...
# OWNER_ID = 6679714610 # edit this
# LOG_GROUP = -1002155139704 # edit this
...
M = "/plan"
PREMIUM_PIC = "https://telegra.ph/file/1397344d7573e29124668.jpg"
PRE_TEXT = """💰 **Premium Price**: Starting from $2.5 or 200 INR accepted via **__PhonePe / Upi / Amazon Gift Card__** (terms and conditions apply).
📥 **Download Limit**: Users can download up to 100 files in a single Bulk command.
...
async def plan_command(event):
    ...
    buttons = [
        [Button.url("Send Payment Here", url="https://t.me/SmexyOP")]
    ]
...
async def help_command(event):
    ...
    buttons = [[Button.url("BUY REPO", url=REPO_URL)]]
...
async def youtube_dl_command(_, message):
    ...
    if len(message.command) > 1:
        ...
        try:
            ...
            caption = f"{video_info['title']}\n\n__**Powered by [𝙎𝙈𝙀𝙓𝙔 𝙎𝙏𝙊𝙍𝙀 🇮🇳](https://t.me/SmexyStore)**__"  # Set caption to the title of the video
